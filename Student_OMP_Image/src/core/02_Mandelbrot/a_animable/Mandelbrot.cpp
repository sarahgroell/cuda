...
Mandelbrot::Mandelbrot(uint w, uint h, int dt, const DomaineMath& domaineMath) :
...
void Mandelbrot::animationStep()
    {
    this->t = variateurAnimation.varierAndGet(); // in [30,100]. t représente N de MandelbrotMath
    }
...
void Mandelbrot::processForAutoOMP(uchar4* ptrTabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    MandelbrotMath mandelbrotMath = MandelbrotMath(t); // ici pour preparer cuda
